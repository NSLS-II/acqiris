...
static int
rli_MASBus_m_BusNb(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MASBus_m_IsMaster(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MASBus_m_PosInCrate(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MASBus_m_SerialNb(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MASBus_m_SlotNb(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MCrateNb(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MHasTrigVeto(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MIsPreTriggerRunning(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MLogDevDataLinks(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MMaxSamplesPerChannel(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MNbrADCBits(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MNbrExternalTriggers(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MNbrInternalTriggers(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MNbrModulesInInstrument(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MPosInCrate(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MTbSegmentPad(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MTemperature_m(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
static int
rli_MEventCount(rec_t* rec, ad_t* ad, int32_t* val)
{
    *val = ad->count;
    return 0;
}
...
static int
rli_MTriggerTimeouts(rec_t* rec, ad_t* ad, int32_t* val)
{
    *val = ad->timeouts;
    return 0;
}
...
static int
rli_MReadErrors(rec_t* rec, ad_t* ad, int32_t* val)
{
    *val = ad->readerrors;
    return 0;
}
...
static int
rli_MTruncated(rec_t* rec, ad_t* ad, int32_t* val)
{
    *val = ad->truncated;
    return 0;
}
...
static int
rli_COverloadStatus(rec_t* rec, ad_t* ad, int32_t* val)
{
    char s[256];
...
typedef int
(*acqiris_parli_rfunc)(rec_t* rec, ad_t* ad, int32_t* val);
...
template<>
    int
    acqiris_init_record_specialized(longinRecord* pli)
    {
...
template<>
    int
    acqiris_read_record_specialized(longinRecord* pli)
    {
        acqiris_record_t* arc = reinterpret_cast<acqiris_record_t*> (pli->dpvt);
        ad_t* ad = &acqiris_drivers[arc->module];
        acqiris_lirecord_t* rli =
                reinterpret_cast<acqiris_lirecord_t*> (arc->pvt);
