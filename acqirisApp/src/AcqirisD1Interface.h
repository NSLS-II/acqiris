...
//
//----------------------------------------------------------------------------------------
//  Copyright Acqiris, Inc. 2001, 2002-2008
//
//  Purpose:    Declaration of $prefixD1$ device driver API
//
///////////////////////////////////////////////////////////////////////////////////////////////////
...
/*! NOTE: Due to the destination 'sumArray' type, this routine should be called at most
    ...
    'readPar'      = pointer to a user-supplied structure that specifies what and how to read,
                     as needed for the function '$prefixD1$_readData'.
...
// or one of those from '$generic$Interface.h'
//
///////////////////////////////////////////////////////////////////////////////////////////////////
