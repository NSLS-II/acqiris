...
!BeginPrivate!
    flags = 3 is used to set the values for the TC840/TC890 ramps corrections.
      deviceName should be set to "EEPROM1Dev1", and filePathName should be a space separated
      list of 13 decimal integer values in units of 50ps ordered as Common, 12 ... 1.
   flags = 4 clear flash TBL table (flash devices only).
!EndPrivate!
